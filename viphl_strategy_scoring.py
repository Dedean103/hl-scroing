...
class VipHLStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        viphl_settings = Settings(
            ...
            mn_start_point_high=self.p.mn_start_point_high,
            mn_start_point_low=self.p.mn_start_point_low,
            mn_cap_high=self.p.mn_cap_high,
            mn_cap_low=self.p.mn_cap_low,
            mn_start_point_high_trend=self.p.mn_start_point_high_trend,
            mn_start_point_low_trend=self.p.mn_start_point_low_trend,
            mn_cap_high_trend=self.p.mn_cap_high_trend,
            mn_cap_low_trend=self.p.mn_cap_low_trend,
