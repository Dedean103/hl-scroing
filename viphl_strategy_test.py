...
param_grid = {
    #'mintick': [0.01, 0.02],
    #'close_above_low_threshold': [0.5, 1.0, 1.25],
    #'lookback': [400, 600, 800],
    'high_by_point_n': [4, 5, 6, 7, 8, 9, 10],
    'low_by_point_n': [4, 5, 6, 7, 8, 9, 10],
    'high_by_point_n_on_trend':[4, 5, 6, 7, 8, 9, 10],
    'low_by_point_n_on_trend':[4, 5, 6, 7, 8, 9, 10],
    #'close_above_hl_threshold':[0.1, 0.25, 0.4],
    #'close_above_low_threshold':[1, 1.25, 1.75],
    ...
    #'close_avg_percent_lookback':[100, 200, 400],
...
keys = [#'mintick', 'close_above_low_threshold',
         #'lookback', 
        'high_by_point_n', 'low_by_point_n',
        'high_by_point_n_on_trend','low_by_point_n_on_trend',
...
def init_dataframe(path='ETH.csv'):
